...
class Bot:
    ...
    def _reconcile(self):
        """Clean ghost trades — any open trade not on Delta → mark closed."""
        ...
        for t in self.trades:
            ...
            if sym not in real_syms and pid not in real_syms:
                t["exit"]=t.get("entry",0); t["pnl"]=0.0
                t["won"]=False; t["reason"]="reconciled"
                self.emit("WARN",f"Ghost reconciled: {sym or pid}")
