...
def api_opts_find():
    ...
    d=request.json or {}
    # If specific symbol requested, look it up directly
        ...
        if td and td.get("success"):
            ...
            if mark>0:
                return jsonify({"found":True,"symbol":sym_override,"mark":round(mark,4),
                    ...
                    "type":d.get("type","call"),"strike":int(sym_override.split("-")[2]) if "-" in sym_override else 0})
...
_DASH = _b64.b64decode("").decode("utf-8")
